...
\includegraphics[width=\textwidth]{img_tmp/david_pleio_2.eps}
		    \end{minipage}
		    \mycaptionfig{Gene ontology analysis of eGenes of variants associated to three (\textbf{a}) and two (\textbf{b}) GWAS categories compared to eGenes of variants associated to one GWAS category.}
	    \end{center}
	\end{minipage}
