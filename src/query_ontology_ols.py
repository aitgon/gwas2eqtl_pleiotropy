...
for query_term in sorted(mygwas_df['query_term'].unique()):
    ...
    print(query_ontology)
    ols_url = "https://www.ebi.ac.uk/ols4/api/search?q={query_term}&query_ontology={query_ontology}".format(query_term=urllib.parse.quote(query_term), query_ontology=query_ontology)
