...
from src.gwas2eqtl_pleiotropy_logger import Logger
from src.gwas2eqtl_pleiotropy_db import Base, gwas_annot
...
Base.metadata.tables["gwas_annot"].create(bind=engine)
