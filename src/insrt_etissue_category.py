...
from gwas2eqtl_pleiotropy_db import Base, eqtl_annot
...
Base.metadata.tables["eqtl_annot"].create(bind=engine)

eqtl_annot_df = pandas.read_excel(etissue_cat_ods_path, index_col=None, header=0)

eqtl_url = "https://raw.githubusercontent.com/eQTL-Catalogue/eQTL-Catalogue-resources/00ea8a7abca895f26c3aee74ece1307dc5054ace/tabix/tabix_ftp_paths.tsv"
