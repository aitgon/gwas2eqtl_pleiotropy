...
from gwas2eqtl_pleiotropy_db import Base, opengwas2trait_ontology
...
if sqlalchemy.inspect(engine).has_table(opengwas2trait_ontology.__tablename__):
    opengwas2trait_ontology.__table__.drop(engine)
Base.metadata.tables[opengwas2trait_ontology.__tablename__].create(bind=engine)
