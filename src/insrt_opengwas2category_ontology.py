...
from gwas2eqtl_pleiotropy_db import Base, opengwas2category_ontology
...
if sqlalchemy.inspect(engine).has_table(opengwas2category_ontology.__tablename__):
    opengwas2category_ontology.__table__.drop(engine)
Base.metadata.tables[opengwas2category_ontology.__tablename__].create(bind=engine)
...
gwas_annot_df.to_sql('opengwas2category_ontology', con=engine, if_exists='append', index=True, index_label='gwas_id')
