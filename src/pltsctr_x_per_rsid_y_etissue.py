...
from src.constants import tick_fontsize, label_fontsize, scatter_dot_size, dpi
...
from src.constants import seaborn_theme_dic
...
pleiotropic_regions_df = region_window_100000_df.loc[
    region_window_100000_df['gwas_category_count'] >= pleio_high_cutoff, ['chrom', 'start', 'end', 'gwas_category_count']]
