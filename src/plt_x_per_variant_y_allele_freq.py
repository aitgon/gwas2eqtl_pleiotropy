...
from constants import label_fontsize, tick_fontsize, boxenplot_kws
...
m_df.dropna(subset=['afr_af', 'amr_af', 'eas_af', 'eur_af', 'sas_af'], how='all', inplace=True)
...
for y, ytitle in zip(y_labels, y_titles):
    ...
    plt.yticks(ticks=[0.2, 0.4, 0.6, 0.8, 1], labels=[0.2, 0.4, 0.6, 0.8, 1], fontsize=tick_fontsize)
    plt.ylim(ylim)
