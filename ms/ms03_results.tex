...
%
Among these studies, there 10,627 clumped leading variants with a p-value below 5e-8 from 335 GWAS (Supplementary table 2).
% sqlite
...
%
and the percentage of variants with a colocalized eQTL is 37\%, 21\% and 42\% in these classe, respectively (Supplementary table ST6).
%
