...
\subsection*{Trait, eQTL gene and tissue frequency of individual eQTLs in pleiotropic regions}

In Figure \ref{fig:region_gwas_egenes_tissues}, I have plotted the number of trait classes, eQTL genes and tissues of
eQTLs in three pleiotropic regions.
%
