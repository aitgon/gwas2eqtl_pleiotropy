...
% TODO: Add to supplementary table?
...
The colocalization pipeline uncovered eQTL colocalizations for 5,484 of the leading GWAS variants with 7,040 eQTL genes and 127 eQTL biosamples in the somatic chromosomes 1-22 \cite{2019.Posthuma.Watanabe,2021.Li.Mu}.
%
...
%
The histogram shows three groups of GWAS (Fig. \ref{fig:hist_perc_tophits_eqtl_excl_mhc}).
%
There were 100\% of leading variants explained with eQTLs for between 5\% and 12\% of the GWAS depending on whether
we set PP.H4.SNP at 0.25, 0.5 or 0.75 (Fig. \ref{fig:hist_perc_tophits_eqtl_excl_mhc} and suppl. fig. S1).
This parameter gives the posterior probability of a SNP in a window to be causal.
%
There were a middle group of maximally 5\% GWAS with maximum percentage of explained leading SNPs between 10\% and 50\%
depending on the PP.H4.SNP parameter 0.25-0.75
Around 25\% of GWAS had no tophits colocalized with eQTLs for a parameter PP.SNP.H4=0.5.
%
Finally, between 17\% and 27\% GWAS had 0\% of leading variants explained by eQTLs (Fig. \ref{fig:hist_perc_tophits_eqtl_excl_mhc} and suppl. fig. S1).
...
These variants annotated with GWAS association and gene expression associations in particular biosamples are useful functional informations.
%
