...
I excluded colocalization in the MHC locus in chromosome 6 between position 25,000,000 and 35,000,000.
%
My pipeline uncovered eQTL colocalizations for 5,484 of the leading GWAS variants with 7,040 eQTL genes and 127 eQTL biosamples.
...
%
The histogram shows three group of GWAS (Fig. \ref{fig:hist_perc_tophits_eqtl_excl_mhc}).
%
Around 25\% of GWAS had no tophits colocalized with eQTLs.
%
On the other extreme, 7.5\% of GWAS had all 100\% tophits colocalized with eQTLs.
%
The other GWAS had between 10\% and 50\% of tophits colocalized with eQTLs.
