...
%
In Fig. \ref{fig:1}b-d, I show three screenshots of this UCSC track hub for three different biosamples, namely monocytes, and  frontal cortex biosamples in the chromosome 5 around the gene IL4 (Fig. \ref{fig:1}a).
%
