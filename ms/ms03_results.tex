...
% select count(*) from (select distinct tophits.chrom,tophits.pos,tophits.ea,tophits.rsid from tophits inner join coloc on coloc.rsid=tophits.rsid where coloc.pp_h4_abf>=0.75) as sel; 5484
