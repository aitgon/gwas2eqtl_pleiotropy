...
My colocalization pipeline was initially based on another pipeline that is at the eQTL Catalogue Github repository ( \url{https://github.com/eQTL-Catalogue/colocalisation} ).
%
First lead eQTLs with FDR 0.05 in each sample are selected and surrounding eQTL and GWAS variants with radius of 500,000 nt (Total window 1,000,000 nt) are retrieved.
%
