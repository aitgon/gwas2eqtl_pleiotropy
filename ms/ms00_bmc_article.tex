...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \title{Pleiotropic expression quantative trait loci are associated to a higher number of target genes and a lower effect on target genes and traits}
...
%  \orgdiv{Department of Science},             % department, if any
            \orgname{aitor.gonzalez@univ-amu.fr. Aix Marseille Univ, INSERM, TAGC},          % university, etc
            \city{Marseille},                              % city
            \cny{France}                                 % countr
        }
