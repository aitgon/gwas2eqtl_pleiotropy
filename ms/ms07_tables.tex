...
\begin{table}[h!]
    ...
    head,
    table head=\\\hline \bfseries Chrom. & \bfseries Pos (hg38) & \bfseries Cytoband & \bfseries RSID & \bfseries Gene marker& \bfseries GWAS Categories\\\hline,
    ...
    \vspace{15pt}
    %
    \caption{Represantive pleiotropic eQTLs involved in four GWAS categories in different cytobands.
...
\begin{table}[h!]
    ...
    \csvreader[
        ...
        late after last line=\\\hline,
        head,
        table head=\\\hline \bfseries Chr. & \bfseries Start & \bfseries End & \bfseries Cytob. & \bfseries Marker eQTL gene & \bfseries GWAS Categories\\\hline,
