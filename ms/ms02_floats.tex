...
\end{subfigure}
%
\caption{Gene ontology analysis of egenes of variants associated to three (\textbf{a}) and two (\textbf{b}) GWAS categories compared to egenes of variants associated to one GWAS category.} \label{fig:gene_ontology}
\end{figure*}
