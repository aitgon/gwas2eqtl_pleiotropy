...
\end{subfigure}
%
\caption{\textbf{TODO.} (\textbf{a}) TODO.} \label{fig:freq_gwas_egene_etisue_per_variant}
%
\end{figure*}
...
\textbf{a}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/plt_violin_beta_pval.py/eqtl_beta.png}
\end{subfigure}
%
\begin{subfigure}[]{.33\textwidth}
\textbf{b}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/plt_violin_beta_pval.py/gwas_beta.png}
\end{subfigure}
%
