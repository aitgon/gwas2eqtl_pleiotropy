...
\begin{figure}[h!]
    ...
    \begin{subfigure}[]{.45\textwidth}
        \textbf{a}
        \\
        \includegraphics[width=\textwidth]{\floatRelativePath/pltbar_x_per_variant_etissue_y_egene.py/violin.png}
        %
    \end{subfigure}
    %
    \begin{subfigure}[]{.45\textwidth}
        \textbf{b}
        \\
        \includegraphics[width=\textwidth]{\floatRelativePath/pltbar_x_per_variant_egene_y_etissue.py/violin.png}
    \end{subfigure}
    %
