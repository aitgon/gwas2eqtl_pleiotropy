...
\textbf{a}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/cmpt_perc_tophits_eqtl.py/autoimmune_disease.png}
\end{subfigure}
%
\begin{subfigure}[]{.24\textwidth}
\textbf{b}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/cmpt_perc_tophits_eqtl.py/cardiovascular_disease.png}
\end{subfigure}
%
\begin{subfigure}[]{.24\textwidth}
\textbf{c}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/cmpt_perc_tophits_eqtl.py/digestive_system_disease.png}
\end{subfigure}
%
\begin{subfigure}[]{.24\textwidth}
\textbf{d}
\\
\includegraphics[width=\textwidth]{\floatRelativePath/cmpt_perc_tophits_eqtl.py/mental_or_behavioural_disorder.png}
\end{subfigure}
