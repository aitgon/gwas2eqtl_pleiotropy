...
~~~
python scripts/query_ontology_ols.py config/gwas417_trait_query.ods out/v20230901/query_ontology.py/gwas_trait_ontology.ods
python scripts/query_ontology_ols.py config/gwas417_category_query.ods out/v20230901/query_ontology.py/gwas_category_ontology.ods
~~~
...
~~~
python scripts/insrt_opengwas2trait_ontology.py postgresql://postgres:postgres@0.0.0.0:5435/postgres out/v20230901/query_ontology.py/gwas_trait_ontology.ods
python scripts/insrt_opengwas2category_ontology.py postgresql://postgres:postgres@0.0.0.0:5435/postgres out/v20230901/query_ontology.py/gwas_category_ontology.ods
~~~
...
export OUTDIR=out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50
~~~

~~~
snakemake -p --cores all -s tools/00snkfl_all.yml --config david_email=${DAVID_EMAIL} db_url=postgresql://postgres:postgres@0.0.0.0:5435/postgres etissue_category_ods=config/etissue_category.ods gwas_trait_ods=out/v20230901/query_ontology.py/gwas_trait_ontology.ods  gwas_category_ods=out/v20230901/query_ontology.py/gwas_category_ontology.ods pleio_high_cutoff=3 ms_table_eqtl_pleio_cutoff=4 ms_table_region_pleio_cutoff=6 outdir="${OUTDIR}" public_data_dir="${HOME}"/Software/public snp_pp_h4="${SNP_PP_H4}"

snakemake -p --cores all -s tools/snkfl_vep.yml --config db_url=postgresql://postgres:postgres@0.0.0.0:5435/postgres pleio_high_cutoff=3 outdir="${OUTDIR}" public_data_dir=/home/gonzalez/Software/public process_data_dir=/home/gonzalez/Software/process snp_pp_h4="${SNP_PP_H4}"  --use-singularity --singularity-args '-B /home/gonzalez/Software/vep-cache:/opt/vep/vep-cache'
...
~~~
singularity pull --name out/vep.sif docker://ensemblorg/ensembl-vep

time singularity exec -B  /home/gonzalez/Software/vep-cache:/opt/vep/vep-cache out/vep.sif vep --offline --dir_cache /opt/vep/vep-cache -cache_version 108 --force_overwrite -i out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50/cmpt_vep.py/vep_input.tsv --output_file out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50/cmpt_vep.py/vep_output.tsv
~~~

UCSC track hub

~~~
snakemake -p --cores 1 -s tools/06_ucsc_hubs.yml --config outdir=out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50 public_data_dir=/home/gonzalez/Software/public snp_pp_h4=0.50 db_url=postgresql://postgres:postgres@0.0.0.0:5435/postgres
python scripts/cmpt_track_hub.py out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50/cmpt_ucsc_tracks_eqtl_inter_bed.py/bigbed out/v20230901/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50/cmpt_count_per_rsid.py/count_per_rsid_gwas_egene_etissue.ods  ../gwas2eqtl_trackhub
~~~
...
rm -f *.aux *.dvi *.log *.out; texi2pdf ms00_fig_table_suppl_boxenplot.tex; rm -f *.aux *.dvi *.log *.out
~~~
