...
\begin{itemize}
\item Disease clusters are coherent $\rightarrow$ Validates approche and data
...
\begin{itemize}
\item This could explain why pleiotropic variants active in more etissues and associated to more egenes
\end{itemize}
...
\vfill
%
Conclusion about regulatory characteristics of pleiotropic variants
%
\begin{itemize}
