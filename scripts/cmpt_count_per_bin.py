...
from gwas2eqtl_pleiotropy.constants import coloc_raw_tsv_path
...
#%% Input1
h4_annot_tsv_path = os.path.join(PathManager.get_outdir_path(), "annotate_db.py", "h4_annotated.tsv")
