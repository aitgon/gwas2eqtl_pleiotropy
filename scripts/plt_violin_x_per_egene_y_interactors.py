...
m_df = m_df[['chrom', 'pos', 'rsid', 'egene', 'protein2', 'gwas_class_count']].drop_duplicates()

# %%
sel_cols = ['egene', 'protein2']

# %%
m2_df = m_df[['chrom', 'pos', 'rsid'] + sel_cols + ['gwas_class_count']].drop_duplicates()
...
m_df = m_df.groupby(['egene', 'gwas_class_count']).count()
m_df = m_df.reset_index()
m_df.columns = ['egene', 'gwas_class_count', 'interactor_count']
