...
# %%
sel_cols = ['rsid', 'egene', 'etissue_class']  # tissue per variant-egene
...
#%%
m_df = m_df.groupby(['rsid', 'egene', 'gwas_class_count']).count()
m_df = m_df.reset_index()
m_df.columns = ['rsid', 'egene', 'gwas_class_count', 'etissue_class_count']
