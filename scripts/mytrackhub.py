...
for bed in glob.glob('/home/gonzalez/Repositories/gwas2eqtl_pleiotropy/out/gwas417/pval_5e-08/r2_0.1/kb_1000/window_1000000/75_50/cmpt_ucsc_tracks_eqtl_interactions.py/*.bed'):
    ...
    name = trackhub.helpers.sanitize(os.path.basename(bed))
    ...
    track = trackhub.Track(
        ...
        source=bed,      # filename to build this track from
        visibility='full',  # shows the full signal
        color='128,0,5',    # brick red
        # autoScale='on',     # allow the track to autoscale
        tracktype='bed',  # required when making a track
    )
