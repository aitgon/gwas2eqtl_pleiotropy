...
~~~
apptainer exec --bind /other_disk --env PUBLIC_DATA_DIR=/path/to/local/data/public results/containers/gwas2eqtl_pleiotropy.sif snakemake -p --cores all -s workflows/20snkfl_all.yml --configfile config/20snkfl_all_30snkfl_vep_fig3f.yml
~~~
...
apptainer exec --bind /other_disk --env PUBLIC_DATA_DIR=/path/to/local/data/public results/containers/gwas2eqtl_pleiotropy.sif snakemake -p --cores all -s workflows/30snkfl_vep_fig3f.yml --configfile config/20snkfl_all_30snkfl_vep_fig3f.yml --use-singularity --singularity-args '-B /path/to/local/vep-cache:/opt/vep/vep-cache'
~~~
